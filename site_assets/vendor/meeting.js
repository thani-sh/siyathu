...
(function() {
    ...
    window.Meeting = function(channel) {
        ...
        function useMediaStream (stream, callback) {
        ...
        // forward stream
        this.forward = function(roomid, stream) {
            useMediaStream(stream, function() {
                !signaler && initSignaler();
                signaler.broadcast({
                    roomid: roomid || self.channel
                });
        ...
        // change room stream to new one new meeting room
        this.changeStream = function(roomid, stream) {
